...
//   private Timestamp rentalReturnScheldule;
//   private Timestamp rentalReturnDate;
   ...
   public String toString() {
      return String.format(
            "책ID=%s, 책이름=%s, 저자=%s, 분야=%s, 부장르=%s, 출판사=%s, 출판일=%s, 수량=%s, 마일리지=%s, 위치=%s, 대여비=%s",
            bookId, title, author, genre, subGenre, publisher, publishedDate, qty, mileage, location, rentalFee);
