...
public class BoardVO {
 ...
 //게시글 insert
   ...
   //공지사항 게시판에 있는 게시글 전체 조회할 때 쓰이는 생성자 
   public BoardVO(int num, String title, String content, Timestamp registerDate, Timestamp modifyDate) {
      super();
      this.num = num;
      this.title = title;
      this.content = content;
   ...
   //독후감or도서요청 게시판에 있는 게시글 전체 조회할 때 쓰이는 생성자
   public BoardVO(int num, String title, String content, String memId, Timestamp registerDate,
